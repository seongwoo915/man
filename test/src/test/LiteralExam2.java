...
public class LiteralExam2 {
	...
	public static void main(String [] args) {
		...
		int n = 15;  // 정수타입 변수를 선언하고 십진수 리터럴15르 대입
		...
		System.out.println(b);  //0*2^3 + 1*2^2 + 0*2^1 + 1*2^0 = 0 + 4 + 0 = 5
		
		//2배수 정수 - 32비트 64비트
		//long타입의 정수는 리터럴뒤에 L 또는 l을붙임
		long l1 = 24l;//long타입 정수 변수를 선언하고 long타입 리터럴을 대입
		
		// = 은 대입을 처리하는 대입 연산자임.
		// = 을 기준으로 왼쪽타입과 오른쪽 타입을 비교하면
		// 연산자인 = 의 왼쪽은 범위가 넓은 정수타입(long) 오른쪽은 범위가 좁은 정수타입(int)
		//정수타입 24가 24L로 변환해서 저장
		long l2 = 24;//long타입 변수를 선언하고 int정수타입 리터럴 대입
